...
bash scripts/eval_and_record.sh \
  1 \
  logs/eval_tta_scale1536_20260523.log \
  reports/eval_tta_scale1536_20260523.json \
  2026-05-23 \
  infer_tta_scale1536_20260523 \
  local_val \
  ...
  "det_tta_mode=scale1536; slice_size=0; cls_min_prob=0.33; cls_min_margin=0.07" \
  --slice-size 0 \
  --slice-overlap 0 \
  --slice-merge-iou 0.50 \
  --det-tta-mode scale1536 \
  --iou-threshold 0.5
