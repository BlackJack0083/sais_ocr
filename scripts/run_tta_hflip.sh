...
bash scripts/eval_and_record.sh \
  0 \
  logs/eval_tta_hflip_20260523.log \
  reports/eval_tta_hflip_20260523.json \
  2026-05-23 \
  infer_tta_hflip_20260523 \
  local_val \
  ...
  "det_tta_mode=hflip; slice_size=0; cls_min_prob=0.33; cls_min_margin=0.07" \
  --slice-size 0 \
  --slice-overlap 0 \
