...
bash scripts/eval_and_record.sh \
  1 \
  logs/eval_slice1792_20260523.log \
  reports/eval_slice1792_20260523.json \
  2026-05-23 \
  infer_slice1792_20260523 \
  local_val \
  ...
  "slice_size=1792; slice_overlap=320; slice_merge_iou=0.50; cls_min_prob=0.33; cls_min_margin=0.07; det_tta_mode=none" \
  --slice-size 1792 \
  --slice-overlap 320 \
